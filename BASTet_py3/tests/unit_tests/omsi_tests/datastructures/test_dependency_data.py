...
class test_omsi_dependency(unittest.TestCase):
    ...
    def test__setitem__dependency_type(self):
        ...
        self.assertEqual(dependency_object['dependency_type'], dependency_dict.dependency_types['co_modality'])
    ...
    def test__setitem__param_name(self):
        ...
        self.assertEqual(dependency_object['param_name'], my_parameter)
    ...
    def test__setitem__link_name(self):
        ...
        self.assertEqual(dependency_object['link_name'], my_parameter)
    ...
    def test__setitem__dataname(self):
        ...
        self.assertEqual(dependency_object['dataname'], my_parameter)
        self.assertIsNone(dependency_object['_data'])
    ...
    def test__setitem__selection_string_index(self):
        ...
        self.assertEqual(dependency_object['selection'], selection_string)
